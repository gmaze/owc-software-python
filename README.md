...
Download the code from github, using a git software or the command line:
```bash
git clone git@github.com:gmaze/owc-software-python.git
```
...
To test your installation before changing anything, run the code in your terminal by entering the owc_software_python directory and using the command:
